 ...
 * Values mirror theme.css dark canvas + THEME_COLOR_LIGHT oxblood — no runtime CSS import.
...
function buildOfflineHtml(reqId) {
  ...
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#91343d"><title>Temporarily unavailable</title><style>body{font-family:'Source Sans 3','Space Grotesk',ui-sans-serif,system-ui,sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;background:oklch(0.14 0.012 40);color:oklch(0.97 0.005 95)}.card{background:oklch(0.18 0.012 40);border:1px solid oklch(0.97 0.005 95 / 0.12);border-radius:12px;padding:24px;max-width:560px;box-shadow:0 8px 32px oklch(0 0 0 / 0.35)}h1{font-family:'Space Grotesk',ui-sans-serif,system-ui,sans-serif;font-size:20px;margin:0 0 8px}p{margin:0 0 12px;color:oklch(0.82 0.012 40)}a.btn{display:inline-block;background:oklch(0.46 0.125 18);color:oklch(0.98 0.005 95);font-weight:700;padding:8px 12px;border-radius:8px;text-decoration:none}.meta{margin-top:8px;font-size:12px;color:oklch(0.72 0.012 40)}a.link{color:oklch(0.68 0.11 20)}</style></head><body><div class="card"><h1>We're updating things</h1><p>Please try again in a moment. If this persists, contact me via <a class="link" href="https://www.linkedin.com/in/blakeoxford">LinkedIn</a>.</p><a class="btn" href="/">Go home</a><div class="meta">Correlation ID: ${safeId}</div></div></body></html>`;
}
