 ...
 * Values mirror theme.css dark canvas + THEME_COLOR_LIGHT teal — no runtime CSS import.
...
function buildOfflineHtml(reqId) {
  ...
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#008384"><title>Temporarily unavailable</title><style>body{font-family:'Source Sans 3','Space Grotesk',ui-sans-serif,system-ui,sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;background:oklch(0.16 0.012 250);color:oklch(0.97 0.008 250)}.card{background:oklch(0.2 0.012 250);border:1px solid oklch(0.97 0.008 250 / 0.12);border-radius:12px;padding:24px;max-width:560px;box-shadow:0 8px 32px oklch(0 0 0 / 0.35)}h1{font-family:'Space Grotesk',ui-sans-serif,system-ui,sans-serif;font-size:20px;margin:0 0 8px}p{margin:0 0 12px;color:oklch(0.82 0.015 250)}a.btn{display:inline-block;background:oklch(0.55 0.1 195);color:oklch(0.98 0.008 250);font-weight:700;padding:8px 12px;border-radius:8px;text-decoration:none}.meta{margin-top:8px;font-size:12px;color:oklch(0.72 0.015 250)}a.link{color:oklch(0.72 0.09 198)}</style></head><body><div class="card"><h1>We're updating things</h1><p>Please try again in a moment. If this persists, contact me via <a class="link" href="https://www.linkedin.com/in/blakeoxford">LinkedIn</a>.</p><a class="btn" href="/">Go home</a><div class="meta">Correlation ID: ${safeId}</div></div></body></html>`;
}
