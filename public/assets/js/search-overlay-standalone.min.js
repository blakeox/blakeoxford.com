  ...
  class SearchOverlay {
    ...
    async init() {
      try {
        ...
        this.initialized = true; try { if (this.overlay && this.overlay.hasAttribute && this.overlay.hasAttribute('data-authoritative-closed')) { try { window.__TEST_EVENT_LOG.push({ event: 'standalone-initialized-but-authoritative-closed', ts: Date.now() }); } catch(e) {} } } catch(e) {}
