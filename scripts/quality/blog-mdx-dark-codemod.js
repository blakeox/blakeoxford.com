...
const REPLACEMENTS = [
  ...
  [
    /\bfrom-accent to-primary dark:from-accent-light dark:to-primary-light\b/g,
    'from-accent-emphasis to-primary-emphasis',
  ],
  [
  ...
  [
    /\bfrom-primary to-accent dark:from-primary-light dark:to-accent-light\b/g,
    'from-primary-emphasis to-accent-emphasis',
  ],
...
console.log(
  `[blog-mdx-dark-codemod] total dark: ${totalBefore} → ${totalAfter}${write ? ' (written)' : ' (dry run)'}`
);
if (!write) {
