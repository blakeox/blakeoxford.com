...
describe('component documentation catalog', () => {
  ...
  it('keeps manifest recipe references aligned with the typed recipes', () => {
    const recipeKeys: Record<string, string[]> = {
      ...
      'calloutRecipe.variant': Object.keys(calloutRecipe.variants),
      'contentBandRecipe.variant': Object.keys(contentBandRecipe.variants),
      'contentBandRecipe.align': Object.keys(contentBandRecipe.align),
      timelineRecipe: Object.keys(timelineRecipe),
      'timelineItemRecipe.body': Object.keys(timelineItemRecipe.body),
