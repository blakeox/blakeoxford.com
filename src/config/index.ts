...
export { ConfigManager, getConfig, getConfigManager, defaultConfig, createConfig, validateConfig } from './app-config';
export type { AppConfig, AccessibilityConfig, DropdownConfig, SearchConfig, AnalyticsConfig } from './app-config';
