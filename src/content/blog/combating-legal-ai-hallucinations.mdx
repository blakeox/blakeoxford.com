...
>
  <p class="text-lg leading-relaxed text-foreground/90">
    <strong>courtlistener-mcp</strong> gives MCP-aware assistants direct access to CourtListener data so legal research responses can be tied back to real opinions, dockets, and identifiers instead of model guesswork.
  </p>
  <p class="mt-4 text-3xl font-black text-warning-dark dark:text-warning-light">
...
<div class="not-prose my-10">
  <ButtonGroup align="start" responsive>
    <Button href="https://github.com/blakeox/courtlistener-mcp" target="_blank" rel="noopener noreferrer">
      View on GitHub
    </Button>
