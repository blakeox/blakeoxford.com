...
const coverageByRecipe: Record<ComponentRecipeReference['recipe'], VariantCoverage> = {
  ...
  'calloutRecipe.variant': 'structural',
  'contentBandRecipe.variant': 'structural',
  'contentBandRecipe.align': 'structural',
  timelineRecipe: 'structural',
  'timelineItemRecipe.body': 'structural',
