...
export const componentDocs: ComponentDoc[] = [
  ...
  },
  {
    ...
    category: 'Features',
    subcategory: 'Search',
    description: 'Modal search interface. Full-screen modal overlay with fuzzy search functionality. Uses Fuse.js for client-side search across blog posts and projects. Includes keyboard shortcuts (Cmd+K, Escape) and focus management.',
    ...
    tags: ['search', 'modal', 'overlay', 'fuzzy-search', 'keyboard-shortcuts'],
  },
  {
    name: 'AboutTimeline',
    category: 'Features',
