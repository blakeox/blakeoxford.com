...
export const SEMANTIC_COLOR_USAGE: Record<string, string> = {
  ...
  'muted-foreground': 'Secondary body copy (stronger hierarchy)',
  'subtle-foreground': 'Captions, meta, and small-caps only (weaker, still AA)',
  border: 'Dividers and outlines',
  accent: 'Primary actions — pair with on-accent',
  'on-accent': 'Foreground paired with bg-accent / button-primary',
  'button-disabled-bg': 'Disabled control surface — prefer over opacity alone',
  'button-disabled-fg': 'Disabled control text',
  'button-disabled-border': 'Disabled control border',
  'field-bg': 'Form and overlay field backgrounds',
