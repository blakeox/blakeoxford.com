...
export function ChatProvider({ children, initialMessages }: ChatProviderProps) {
	...
	const addMessage = useCallback((message: ChatMessage) => dispatch({ type: 'ADD_MESSAGE', payload: message }), []);
	const updateMessage = useCallback(
		(id: string, updates: Partial<ChatMessage>) => dispatch({ type: 'UPDATE_MESSAGE', payload: { id, updates } }),
		[]
	);
	...
	const value = useMemo<ChatContextValue>(
		...
		[state, openChat, closeChat, setInput, addMessage, updateMessage, clearMessages, setError, toggleMemory]
	);
