...
export const SUGGESTION_CHIP =
  'focus-ring-interactive rounded-full border border-border/55 bg-surface/40 px-3 py-1.5 text-xs text-muted-foreground transition hover:border-accent/45 hover:bg-accent/5 hover:text-accent';

export const SUGGESTION_CHIP_ACCENT =
  'focus-ring-interactive inline-flex items-center gap-2 rounded-full border border-accent/35 bg-accent/10 px-3 py-1.5 text-xs font-medium text-accent transition hover:bg-accent/15';
