 ...
 * ```
 */
export function useChatStorage(options: UseChatStorageOptions): UseChatStorageReturn {
  const { messages, useMemory, onMessagesRestored, maxRestoreMessages = 30 } = options;
