 ...
 */
function QualityIndicator({ message, totalSources }: { message: ChatMessageBubbleProps['message']; totalSources: number }) {
...
function CitationLinks({ 
	...
	sources: NonNullable<ChatMessageBubbleProps['message']['sources']>; 
	messageId: string;
...
function SourcesList({
	...
	message: ChatMessageBubbleProps['message'];
	sources: NonNullable<ChatMessageBubbleProps['message']['sources']>;
	showAllSources: boolean;
	primarySource: typeof sources[0] | null;
	...
	sourceRefs: ChatMessageBubbleProps['sourceRefs'];
...
function SourceMetadata({
	...
	source: NonNullable<ChatMessageBubbleProps['message']['sources']>[0];
...
function MatchedCTA({
	...
	message: ChatMessageBubbleProps['message'];
	messages: ChatMessageBubbleProps['messages'];
	sources: NonNullable<ChatMessageBubbleProps['message']['sources']>;
}) {
...
function MessageActions({
	...
	message: ChatMessageBubbleProps['message'];
	messages: ChatMessageBubbleProps['messages'];
	primarySource: NonNullable<ChatMessageBubbleProps['message']['sources']>[0] | null;
	copiedMessageId: string | null;
	copiedShareUrl: string | null;
	isHelpful: boolean;
	isNotHelpful: boolean;
	handleCopyMessage: (message: ChatMessageBubbleProps['message']) => void;
	handleOpenPrimarySource: (url: string) => void;
