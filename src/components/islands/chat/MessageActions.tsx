	...
	return (
		<div className="flex flex-wrap items-center gap-1.5">
			...
			{!compact && primarySource?.url ? (
				<button type="button" className={chip} onClick={() => handleOpenPrimarySource(primarySource.url)}>
					Source
				</button>
			) : null}
			...
			<div className="ml-auto inline-flex items-center gap-1">
				...
				>
					<svg className="size-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} aria-hidden="true">
						<path strokeLinecap="round" strokeLinejoin="round" d="M7 11v8a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1h3Zm0 0 4.2-7.2A1.5 1.5 0 0 1 12.5 3H13a2 2 0 0 1 2 2v4h4.4a2 2 0 0 1 1.96 2.4l-1.1 6A2 2 0 0 1 18.3 19H9" />
					</svg>
				</button>
				<button
					type="button"
				...
				>
					<svg className="size-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} aria-hidden="true">
						<path strokeLinecap="round" strokeLinejoin="round" d="M17 13V5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-3Zm0 0-4.2 7.2A1.5 1.5 0 0 1 11.5 21H11a2 2 0 0 1-2-2v-4H4.6a2 2 0 0 1-1.96-2.4l1.1-6A2 2 0 0 1 5.7 5H15" />
					</svg>
				</button>
			</div>
		</div>
