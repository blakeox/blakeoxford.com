...
export const MatchedCTA = memo(function MatchedCTA({
	...
	return (
		<div className="mt-2 rounded-lg border border-accent/25 bg-accent/5 p-3">
			...
			<a
				href={matchedCTA.ctaLink}
				className="inline-flex items-center gap-2 rounded-lg bg-accent px-3 py-2 text-sm font-medium text-on-accent transition hover:bg-accent-dark focus-ring-interactive"
				onClick={() => {
					autoragEvents.ctaClick({
						type: 'quality-suggestion',
						label: matchedCTA.ctaText,
