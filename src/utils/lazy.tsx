 ...
 */
async function withRetry<T>(factory: () => Promise<T>, options: RetryOptions = {}): Promise<T> {
...
export function createLazyComponent<P extends object>(
  ...
  LazyWrapper.displayName = displayName ? `Lazy(${displayName})` : 'LazyComponent';
...
export function DefaultLoadingSkeleton(): ReactNode {
  return (
    <div
      className="animate-pulse rounded bg-surface-subtle"
