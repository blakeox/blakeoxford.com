...
export class AccessibilityModule {
  ...
  private addSkipToContentLink(): void {
    ...
    skipLink.className =
      'sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:p-4 focus:bg-accent focus:text-on-accent focus:rounded';
...
if (typeof window !== 'undefined') {
  (
    window as Window & {
      AccessibilityModule?: typeof AccessibilityModule;
      initAccessibilityModule?: typeof initAccessibilityModule;
    }
  ...
  ).initAccessibilityModule = initAccessibilityModule;
}
