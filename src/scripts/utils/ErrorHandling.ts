...
export class ErrorHandlingSystem {
 ...
 placeholder.className = 'image-error-placeholder bg-gradient-to-br from-surface-subtle to-surface rounded-lg flex flex-col items-center justify-center text-foreground/80 text-sm border border-border';
